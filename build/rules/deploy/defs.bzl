...
_DEPLOY_WRAPPER = "//build/deploy:run_deploy.sh"
_ANDROID_DEPLOY_SERVICE_URL = "//build/tools/android:android_deploy_service_url"
_ANDROID_SERVICE_URL_PROFILE = "//build/tools/android:android_service_url_profile"
