...
load("//tools/android:service.bzl", "AndroidStringFlagInfo")
...
_DEPLOY_SERVICE_URL = "//tools/android:android_deploy_service_url"
_SERVICE_URL_PROFILE = "//tools/android:android_service_url_profile"
