---
name: navigation-3
description: Implement Jetpack Navigation 3 in Android apps. Use when installing Navigation 3, applying patterns such as deep links, multiple back stacks, dialogs, bottom sheets, list-detail or two-pane scenes, conditional navigation, returning results from flows, or integrating with Hilt, ViewModel, Kotlin, and view interoperability.
---
