---
name: edge-to-edge
description: Add adaptive edge-to-edge support to Jetpack Compose Android apps and troubleshoot UI obscured by system bars. Use when fixing components that overlap the navigation bar or status bar, resolving IME inset issues, or improving system bar legibility.
---
...
- \[\] Does the project build and test? Run `./build.sh` and `./test.sh` to be sure.
